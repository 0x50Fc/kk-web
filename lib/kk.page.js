...
(function () {
    ...
    var elements = {
        ...
        "editor": kk.TextareaElement
    };

    kk.elements = elements;
    ...
    kk.Page = function (app) {
        ...
        this.padding.set("-20px 0px 0px 0px");
    };
    ...
    kk.Page.prototype = kk.extend(Object.prototype, {
        ...
        createTitleView: function () {
            ...
            this.titleView.setAttrs({ font: '18px', color: '#000', layout: 'relative', margin: '0px 0px 0px 0px', width: '50%', height: '100%', 'text-align': 'center' });
            this.topbar.append(this.titleView);
        },

        createLeftButton: function () {
            this.leftButton = new kk.ButtonElement();
            this.leftButton.setAttrs({ height: '100%', left: '0px', padding: '0px 6px 0px 3px', hidden: 'true' });
        ...
        createTopbar: function () {
            ...
            this.topbar.setAttrs({ width: '100%', top: '0px', height: '44px', 'background-color': '#f7f6f7', layout: 'relative' });
        ...
        createElement: function () {
            ...
            this.element.setAttrs({ width: '100%', height: '100%' });
            return this.element;
        },
                        ...
                        case "left":
                            {
                                ...
                                this.leftView.setAttrs({ "width": "25%", height: "100%", left: "0px", padding: '0px 0px 0px 3px' });
                        ...
                        case "center":
                            {
                                ...
                                this.centerView.setAttrs({ "width": "50%", height: "100%", padding: '0px 0px 0px 0px' });
                        ...
                        case "right":
                            {
                                ...
                                this.rightView.setAttrs({ "width": "25%", height: "100%", padding: '0px 3px 0px 0px', right: '0px' });
        ...
        updateBodyElement: function () {
            if (this.bodyElement) {
                var p = new kk.Edge();
                p.set(this.bodyElement.get("padding"));
                var padding = this.bodyElement.padding;
                padding.top.type = kk.Pixel.TYPE_PX;
                padding.top.value = p.top.valueOf(0, 0) + this.padding.top.valueOf(0, 0);
                padding.left.type = kk.Pixel.TYPE_PX;
                padding.left.value = p.left.valueOf(0, 0) + this.padding.left.valueOf(0, 0);
                padding.bottom.type = kk.Pixel.TYPE_PX;
                padding.bottom.value = p.bottom.valueOf(0, 0) + this.padding.bottom.valueOf(0, 0);
                padding.right.type = kk.Pixel.TYPE_PX;
                padding.right.value = p.right.valueOf(0, 0) + this.padding.right.valueOf(0, 0);
            }
        },
        ...
        open: function (path) {
            ...
            var body = element.firstChild;

            if (body && body instanceof kk.BodyElement) {
            ...
            element.on("layout", function (event) {
            ...
            app.exec(path + ".js", { page: this.data, app: this.appReflect });
